...
const SelfOrdering = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col font-sans max-w-lg mx-auto border-x border-slate-200 shadow-2xl relative">
      ...
      {/* Category Pills */}
      <div className="bg-secondary-dark px-4 pb-4 flex space-x-2 overflow-x-auto no-scrollbar border-b border-white/5">
        {categories.map(cat => (
          <button
            key={cat}
                ...
                >
                   ...
                   <div className="p-3 flex-1">
                     ...
                     <div className="flex items-center justify-between">
                       ...
                       <div className="w-7 h-7 bg-slate-900 group-hover:bg-primary rounded-xl flex items-center justify-center transition-colors shadow-sm">
      ...
      {showCart && (
         <div className="fixed inset-0 z-[100] flex flex-col justify-end">
            ...
            <div className="max-w-lg mx-auto w-full bg-white rounded-t-[2.5rem] shadow-2xl z-10 animate-slide-up max-h-[88vh] flex flex-col">
               ...
               <div className="flex items-center justify-between px-8 pb-4 pt-2 border-b border-slate-100">
                  <div>
               ...
               <div className="flex-1 overflow-y-auto px-8 py-4 space-y-4">
                  {cart.map((item, i) => (
                     <div key={i} className="flex items-center space-x-4 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                        <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center text-2xl shadow-sm border border-slate-100 flex-shrink-0">
               ...
               <div className="p-8 pt-4 border-t border-slate-100 bg-white rounded-b-[2.5rem] space-y-4">
                  <div className="space-y-2">
                     ...
                     <div className="flex justify-between font-black text-xl text-slate-900 pt-2 border-t border-slate-100 mt-2">
                        <span>Total</span>
      ...
      {selectedProduct && (
        <div className="fixed inset-0 z-[200] flex items-end justify-center">
           ...
           <div className="max-w-lg mx-auto w-full bg-white rounded-t-[2.5rem] p-8 shadow-2xl z-10 animate-slide-up">
              <div className="flex items-start justify-between mb-6">
                 ...
                 <button onClick={() => setSelectedProduct(null)} className="p-2 hover:bg-slate-100 rounded-full ml-4">
              ...
              <div className="space-y-3">
                 {selectedProduct.variants.map((v, i) => (
                    <button
                      ...
                      className="w-full flex items-center justify-between p-5 rounded-2xl border-2 border-slate-100 hover:border-primary hover:bg-primary/5 transition-all group active:scale-[0.98]"
                    >
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-md animate-slide-up">
           <div className="bg-white rounded-[2.5rem] w-full max-w-lg shadow-2xl overflow-hidden flex flex-col">
              ...
              <div className="p-8 pb-4 space-y-4">
                 ...
                 {paymentMethod === 'UPI' && (
                   <div className="mt-6 p-6 bg-slate-50 rounded-3xl flex flex-col items-center justify-center border border-slate-100 animate-slide-up">
              ...
              <div className="p-8 pt-4 bg-white border-t border-slate-100 mt-auto">
                 <button 
